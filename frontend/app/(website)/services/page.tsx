				...
				<div className='max-w-7xl mx-auto px-6 py-5'>
					<div className='flex items-center gap-3'>
						...
						<div>
							...
							<p className='text-sm text-slate-600'>Create and manage your amazing tours</p>
						</div>
					</div>
				</div>
			</header>
			...
			<main className='max-w-7xl mx-auto px-6 py-12'>
				...
				{tours.length > 0 && (
					<section>
						<div className='flex items-center justify-between mb-8'>
							<div>
								<h2 className='text-3xl font-bold text-slate-800 mb-2'>Your Tours</h2>
								<p className='text-slate-600'>
									You have {tours.length} tour{tours.length !== 1 ? 's' : ''} created
								</p>
							</div>
						</div>
				...
				{tours.length === 0 && (
					<section className='text-center py-20'>
						...
						<h3 className='text-2xl font-bold text-slate-800 mb-3'>No Tours Yet</h3>
						<p className='text-slate-600 max-w-md mx-auto'>
							Start creating your first tour using the form above. Share your amazing destinations
							with the world!
						</p>
					</section>
				)}
