...
export default function BookingAllocatedGuideTemplate(bookingDetails: BookingDetails) {
	const { tourist_info, travel_details, guide_preferences, booking_configuration } = bookingDetails;
...
<head>
	...
	<title>New Booking Allocation</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
	<div style="background-color: #f4f4f4; padding: 20px; border-radius: 5px;">
		<h1 style="color: #2c3e50; margin-top: 0;">New Booking Allocated to You</h1>
		<p>Hello,</p>
		
		<p>You have been allocated to a new customised booking. Here are the complete details:</p>
		...
		<div style="background-color: #fff3cd; padding: 15px; border-radius: 5px; margin: 20px 0; border-left: 4px solid #ffc107;">
			<p style="margin: 0;"><strong>Important:</strong> Please contact the tourist using the provided contact information to confirm the booking details and coordinate the tour.</p>
		</div>
